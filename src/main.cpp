...
int main(int argc, char* argv[]) {
	...
	for (int i = 0; i < vertices.size(); i++) {
		...
		// Translate and scale each vertex assign random rgb, set normals, then create triangle
